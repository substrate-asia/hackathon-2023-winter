...
namespace Substrate.Hexalem.Console
{
    public class Play
    {
        ...
        public GameResult StartGame()
        {
            ...
            do
            {
                Log.Information("[Turn {turnId}][Round {roundId}][Player {playerId} {aiType}] is currently playing...", hexGame.HexBoardTurn, hexGame.HexBoardRound, hexGame.PlayerTurn, Bots[hexGame.PlayerTurn].AiName);
