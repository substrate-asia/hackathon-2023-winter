...
<div class="bg-gray-100 w-full">
    ...
    {#if fulfilled === true}
        <div class="flex-col flex max-w-screen-md mx-auto gap-10" in:fade={{ duration: 300 }} >
            ...
            <div class="flex items-center flex-col w-full gap-6 bg-white py-[30px] px-6 rounded-lg shadow-lg border">
                <div class="flex items-center sm:flex-row flex-col w-full gap-6 bg-white">
                    <!--Customize your logo-->
                    {#if isInitial === true}
                    ...
                    <div class="flex flex-col rounded-lg shadow-lg border w-full">
                        ...
                        <div class="flex flex-col px-4 py-2 gap-1 bg-white rounded-t-lg text-xl font-bold text-lg">
                            ...
                            <div class="flex justify-between items-center">
                                ...
                                {#if !isInitial}
                                    <!--Upgrade plan-->
                                    <button class="py-0.5 px-1 text-sm bg-pink text-white rounded-lg shadow-md font-semibold" on:click={() =>goto(`/pricing`)} >
                                        Upgrade plan
                                    </button>
                                {/if}
                ...
                <span class="sm:text-base text-sm p-2 border rounded-lg">
                    This chatbot is trained by administrators and experts in the Polkadot ecosystem. 
            ...
            <div class="relative flex flex-col bg-white rounded-lg shadow-lg">
                ...
                {#if !isAdmin && isInitial}
                    <div class="absolute flex flex-col items-center inset-0 bg-black bg-opacity-80 z-30 w-full h-full text-2xl text-white font-semibold rounded-lg shadow-lg">
                        <span class="mt-[200px]">Only admins can modify this AIDOT</span>
                    </div>
                {/if}
