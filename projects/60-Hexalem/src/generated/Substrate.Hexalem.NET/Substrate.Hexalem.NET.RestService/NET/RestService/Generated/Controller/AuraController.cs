...
namespace Substrate.Hexalem.NET.RestService.Generated.Controller
{
    ...
    public sealed class AuraController : ControllerBase
    {
        ...
        /// </summary>
        [HttpGet("Authorities")]
        [ProducesResponseType(typeof(Substrate.Hexalem.NET.NetApiExt.Generated.Model.bounded_collections.bounded_vec.BoundedVecT6), 200)]
        [StorageKeyBuilder(typeof(Substrate.Hexalem.NET.NetApiExt.Generated.Storage.AuraStorage), "AuthoritiesParams")]
        ...
        /// </summary>
        [HttpGet("CurrentSlot")]
        [ProducesResponseType(typeof(Substrate.Hexalem.NET.NetApiExt.Generated.Model.sp_consensus_slots.Slot), 200)]
        [StorageKeyBuilder(typeof(Substrate.Hexalem.NET.NetApiExt.Generated.Storage.AuraStorage), "CurrentSlotParams")]
