...
namespace Substrate.Hexalem.NET.RestService.Generated.Controller
{
    ...
    public sealed class SudoController : ControllerBase
    {
        ...
        /// </summary>
        [HttpGet("Key")]
        [ProducesResponseType(typeof(Substrate.Hexalem.NET.NetApiExt.Generated.Model.sp_core.crypto.AccountId32), 200)]
        [StorageKeyBuilder(typeof(Substrate.Hexalem.NET.NetApiExt.Generated.Storage.SudoStorage), "KeyParams")]
