...
public class TemplateUtil {
    ...
    public static Result toTestTemplate(String abiPath,String solPath,String saveFilePath) throws IOException {
        ...
        for (String filep: filelist) {
            ...
            errText = errText + jsonCheckToClass(fileStr, solBean,solPath)+"|";
     ...
     * @param saveFilePath  js文件存储地址
     */
    public static void saveTestFile(SolBean solBean,String saveFilePath){
        // 创建 FreeMarker 配置
        ...
        try {
            ...
            String filepath = saveFilePath + solBean.getAbiName() + ".js";
...
//                                abi中无参数，但sol有参数，生成TODO给用户提示
    ...
    private static  String findMapKey(Map<String, Integer> keyValueMap,String findstr) throws IOException {
