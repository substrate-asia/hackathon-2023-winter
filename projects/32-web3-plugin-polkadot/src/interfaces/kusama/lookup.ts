...
export default {
  ...
  /**
   * Lookup19: frame_system::EventRecord<staging_kusama_runtime::RuntimeEvent, primitive_types::H256>
   **/
  ...
  /**
   * Lookup34: pallet_staking::pallet::pallet::Event<T>
   **/
  ...
  /**
   * Lookup39: pallet_staking::Forcing
   **/
  ...
  /**
   * Lookup53: pallet_staking::Exposure<sp_core::crypto::AccountId32, Balance>
   **/
  ...
  /**
   * Lookup56: pallet_staking::IndividualExposure<sp_core::crypto::AccountId32, Balance>
   **/
  ...
  /**
   * Lookup61: frame_support::traits::preimages::Bounded<staging_kusama_runtime::RuntimeCall>
   **/
  ...
  /**
   * Lookup67: pallet_babe::pallet::Call<T>
   **/
  PalletBabeCall: {
    _enum: {
      report_equivocation: {
  ...
  /**
   * Lookup68: sp_consensus_slots::EquivocationProof<sp_runtime::generic::header::Header<Number, Hash>, sp_consensus_babe::app::Public>
   **/
  ...
  /**
   * Lookup69: sp_runtime::generic::header::Header<Number, Hash>
   **/
  SpRuntimeHeader: {
    parentHash: 'H256',
    number: 'Compact<u32>',
  ...
  /**
   * Lookup71: sp_consensus_babe::app::Public
   **/
  SpConsensusBabeAppPublic: 'SpCoreSr25519Public',
  /**
   * Lookup73: sp_session::MembershipProof
   **/
  ...
  /**
   * Lookup74: sp_consensus_babe::digests::NextConfigDescriptor
   **/
  ...
  /**
   * Lookup76: sp_consensus_babe::AllowedSlots
   **/
  ...
  /**
   * Lookup78: pallet_indices::pallet::Call<T>
   **/
  PalletIndicesCall: {
    _enum: {
      claim: {
  ...
  /**
   * Lookup85: pallet_staking::pallet::pallet::Call<T>
   **/
  ...
  /**
   * Lookup86: pallet_staking::RewardDestination<sp_core::crypto::AccountId32>
   **/
  ...
  /**
   * Lookup90: pallet_staking::pallet::pallet::ConfigOp<T>
   **/
  ...
  /**
   * Lookup91: pallet_staking::pallet::pallet::ConfigOp<T>
   **/
  ...
  /**
   * Lookup92: pallet_staking::pallet::pallet::ConfigOp<sp_arithmetic::per_things::Percent>
   **/
  ...
  /**
   * Lookup93: pallet_staking::pallet::pallet::ConfigOp<sp_arithmetic::per_things::Perbill>
   **/
  ...
  PalletSessionCall: {
    _enum: {
      set_keys: {
        ...
        keys_: 'StagingKusamaRuntimeSessionKeys',
        proof: 'Bytes',
      },
      purge_keys: 'Null'
    }
  ...
  /**
   * Lookup109: staging_kusama_runtime::SessionKeys
   **/
  ...
  /**
   * Lookup110: polkadot_primitives::v5::validator_app::Public
   **/
  PolkadotPrimitivesV5ValidatorAppPublic: 'SpCoreSr25519Public',
  /**
   * Lookup111: polkadot_primitives::v5::assignment_app::Public
   **/
  ...
  /**
   * Lookup130: pallet_conviction_voting::pallet::Call<T, I>
   **/
  ...
  /**
   * Lookup131: pallet_conviction_voting::vote::AccountVote<Balance>
   **/
  ...
  /**
   * Lookup133: pallet_conviction_voting::conviction::Conviction
   **/
  PalletConvictionVotingConviction: {
    _enum: ['None', 'Locked1x', 'Locked2x', 'Locked3x', 'Locked4x', 'Locked5x', 'Locked6x']
  },
  /**
   * Lookup135: pallet_referenda::pallet::Call<T, I>
   **/
  PalletReferendaCall: {
    _enum: {
      submit: {
  ...
  /**
   * Lookup136: staging_kusama_runtime::OriginCaller
   **/
  ...
  /**
   * Lookup138: staging_kusama_runtime::governance::origins::pallet_custom_origins::Origin
   **/
  ...
  /**
   * Lookup139: polkadot_runtime_parachains::origin::pallet::Origin
   **/
  ...
  /**
   * Lookup141: pallet_xcm::pallet::Origin
   **/
  PalletXcmOrigin: {
    _enum: {
  ...
  /**
   * Lookup142: staging_xcm::v3::multilocation::MultiLocation
   **/
  ...
  /**
   * Lookup143: xcm::v3::junctions::Junctions
   **/
  XcmV3Junctions: {
    _enum: {
      Here: 'Null',
  ...
  /**
   * Lookup144: xcm::v3::junction::Junction
   **/
  XcmV3Junction: {
    _enum: {
  ...
  /**
   * Lookup146: xcm::v3::junction::NetworkId
   **/
  ...
  /**
   * Lookup147: xcm::v3::junction::BodyId
   **/
  XcmV3JunctionBodyId: {
    _enum: {
      Unit: 'Null',
  ...
  /**
   * Lookup148: xcm::v3::junction::BodyPart
   **/
  ...
  SpCoreVoid: 'Null',
  /**
   * Lookup150: frame_support::traits::schedule::DispatchTime<BlockNumber>
   **/
  ...
  /**
   * Lookup152: pallet_ranked_collective::pallet::Call<T, I>
   **/
  ...
  /**
   * Lookup154: pallet_whitelist::pallet::Call<T>
   **/
  PalletWhitelistCall: {
    _enum: {
      whitelist_call: {
  ...
  /**
   * Lookup155: polkadot_runtime_common::claims::pallet::Call<T>
   **/
  ...
  /**
   * Lookup156: polkadot_runtime_common::claims::EcdsaSignature
   **/
  PolkadotRuntimeCommonClaimsEcdsaSignature: '[u8;65]',
  /**
   * Lookup161: polkadot_runtime_common::claims::StatementKind
   **/
  ...
  /**
   * Lookup205: pallet_society::pallet::Call<T, I>
   **/
  PalletSocietyCall: {
    _enum: {
      bid: {
  ...
  /**
   * Lookup206: pallet_recovery::pallet::Call<T>
   **/
  PalletRecoveryCall: {
    _enum: {
      as_recovered: {
  ...
  /**
   * Lookup207: pallet_vesting::pallet::Call<T>
   **/
  PalletVestingCall: {
    _enum: {
      vest: 'Null',
  ...
  /**
   * Lookup208: pallet_vesting::vesting_info::VestingInfo<Balance, BlockNumber>
   **/
  ...
  /**
   * Lookup209: pallet_scheduler::pallet::Call<T>
   **/
  PalletSchedulerCall: {
    _enum: {
      schedule: {
  ...
  PalletProxyCall: {
    _enum: {
      proxy: {
        real: 'MultiAddress',
        forceProxyType: 'Option<StagingKusamaRuntimeProxyType>',
        call: 'Call',
      },
      add_proxy: {
  ...
  /**
   * Lookup214: staging_kusama_runtime::ProxyType
   **/
  ...
  /**
   * Lookup217: pallet_multisig::Timepoint<BlockNumber>
   **/
  ...
  /**
   * Lookup218: pallet_preimage::pallet::Call<T>
   **/
  PalletPreimageCall: {
    _enum: {
      note_preimage: {
  ...
  /**
   * Lookup220: pallet_child_bounties::pallet::Call<T>
   **/
  ...
  /**
   * Lookup221: pallet_election_provider_multi_phase::pallet::Call<T>
   **/
  ...
  /**
   * Lookup222: pallet_election_provider_multi_phase::RawSolution<staging_kusama_runtime::NposCompactSolution24>
   **/
  ...
  /**
   * Lookup223: staging_kusama_runtime::NposCompactSolution24
   **/
  ...
  /**
   * Lookup298: sp_npos_elections::ElectionScore
   **/
  ...
  /**
   * Lookup299: pallet_election_provider_multi_phase::SolutionOrSnapshotSize
   **/
  ...
  /**
   * Lookup303: sp_npos_elections::Support<sp_core::crypto::AccountId32>
   **/
  ...
  /**
   * Lookup307: pallet_nis::pallet::Call<T>
   **/
  PalletNisCall: {
    _enum: {
      place_bid: {
  ...
  /**
   * Lookup314: pallet_nomination_pools::PoolState
   **/
  ...
  /**
   * Lookup317: pallet_nomination_pools::ConfigOp<sp_arithmetic::per_things::Perbill>
   **/
  ...
  /**
   * Lookup318: pallet_nomination_pools::ConfigOp<sp_core::crypto::AccountId32>
   **/
  ...
  /**
   * Lookup319: pallet_nomination_pools::ClaimPermission
   **/
  PalletNominationPoolsClaimPermission: {
    _enum: ['Permissioned', 'PermissionlessCompound', 'PermissionlessWithdraw', 'PermissionlessAll']
  },
  /**
   * Lookup322: pallet_nomination_pools::CommissionChangeRate<BlockNumber>
   **/
  ...
  /**
   * Lookup323: pallet_fast_unstake::pallet::Call<T>
   **/
  ...
  /**
   * Lookup324: polkadot_runtime_parachains::configuration::pallet::Call<T>
   **/
  ...
  /**
   * Lookup325: polkadot_primitives::vstaging::AsyncBackingParams
   **/
  ...
  /**
   * Lookup326: polkadot_primitives::v5::executor_params::ExecutorParams
   **/
  PolkadotPrimitivesV5ExecutorParams: 'Vec<PolkadotPrimitivesV5ExecutorParamsExecutorParam>',
  /**
   * Lookup328: polkadot_primitives::v5::executor_params::ExecutorParam
   **/
  ...
  /**
   * Lookup329: polkadot_primitives::v5::PvfPrepTimeoutKind
   **/
  PolkadotPrimitivesV5PvfPrepTimeoutKind: {
    _enum: ['Precheck', 'Lenient']
  },
  /**
   * Lookup330: polkadot_primitives::v5::PvfExecTimeoutKind
   **/
  PolkadotPrimitivesV5PvfExecTimeoutKind: {
    _enum: ['Backing', 'Approval']
  },
  /**
   * Lookup331: polkadot_runtime_parachains::shared::pallet::Call<T>
   **/
  PolkadotRuntimeParachainsSharedPalletCall: 'Null',
  /**
   * Lookup332: polkadot_runtime_parachains::inclusion::pallet::Call<T>
   **/
  PolkadotRuntimeParachainsInclusionPalletCall: 'Null',
  /**
   * Lookup333: polkadot_runtime_parachains::paras_inherent::pallet::Call<T>
   **/
  ...
  /**
   * Lookup334: polkadot_primitives::v5::InherentData<sp_runtime::generic::header::Header<Number, Hash>>
   **/
  ...
  /**
   * Lookup336: polkadot_primitives::v5::signed::UncheckedSigned<polkadot_primitives::v5::AvailabilityBitfield, polkadot_primitives::v5::AvailabilityBitfield>
   **/
  ...
  /**
   * Lookup339: bitvec::order::Lsb0
   **/
  BitvecOrderLsb0: 'Null',
  /**
   * Lookup341: polkadot_primitives::v5::validator_app::Signature
   **/
  PolkadotPrimitivesV5ValidatorAppSignature: 'SpCoreSr25519Signature',
  /**
   * Lookup343: polkadot_primitives::v5::BackedCandidate<primitive_types::H256>
   **/
  ...
  /**
   * Lookup344: polkadot_primitives::v5::CommittedCandidateReceipt<primitive_types::H256>
   **/
  ...
  /**
   * Lookup345: polkadot_primitives::v5::CandidateDescriptor<primitive_types::H256>
   **/
  ...
  /**
   * Lookup346: polkadot_primitives::v5::collator_app::Public
   **/
  PolkadotPrimitivesV5CollatorAppPublic: 'SpCoreSr25519Public',
  /**
   * Lookup347: polkadot_primitives::v5::collator_app::Signature
   **/
  PolkadotPrimitivesV5CollatorAppSignature: 'SpCoreSr25519Signature',
  /**
   * Lookup349: polkadot_primitives::v5::CandidateCommitments<N>
   **/
  ...
  /**
   * Lookup358: polkadot_primitives::v5::ValidityAttestation
   **/
  ...
  /**
   * Lookup360: polkadot_primitives::v5::DisputeStatementSet
   **/
  ...
  /**
   * Lookup364: polkadot_primitives::v5::DisputeStatement
   **/
  ...
  /**
   * Lookup365: polkadot_primitives::v5::ValidDisputeStatementKind
   **/
  ...
  /**
   * Lookup366: polkadot_primitives::v5::InvalidDisputeStatementKind
   **/
  PolkadotPrimitivesV5InvalidDisputeStatementKind: {
    _enum: ['Explicit']
  },
  /**
   * Lookup367: polkadot_runtime_parachains::paras::pallet::Call<T>
   **/
  ...
  /**
   * Lookup368: polkadot_primitives::v5::PvfCheckStatement
   **/
  ...
  /**
   * Lookup369: polkadot_runtime_parachains::initializer::pallet::Call<T>
   **/
  ...
  /**
   * Lookup370: polkadot_runtime_parachains::hrmp::pallet::Call<T>
   **/
  ...
  /**
   * Lookup371: polkadot_parachain_primitives::primitives::HrmpChannelId
   **/
  ...
  /**
   * Lookup372: polkadot_runtime_parachains::disputes::pallet::Call<T>
   **/
  PolkadotRuntimeParachainsDisputesPalletCall: {
    _enum: ['force_unfreeze']
  },
  /**
   * Lookup373: polkadot_runtime_parachains::disputes::slashing::pallet::Call<T>
   **/
  ...
  /**
   * Lookup374: polkadot_primitives::v5::slashing::DisputeProof
   **/
  ...
  /**
   * Lookup375: polkadot_primitives::v5::slashing::DisputesTimeSlot
   **/
  ...
  /**
   * Lookup376: polkadot_primitives::v5::slashing::SlashingOffenceKind
   **/
  PolkadotPrimitivesV5SlashingSlashingOffenceKind: {
    _enum: ['ForInvalid', 'AgainstValid']
  },
  /**
   * Lookup377: polkadot_runtime_common::paras_registrar::pallet::Call<T>
   **/
  ...
  /**
   * Lookup378: polkadot_runtime_common::slots::pallet::Call<T>
   **/
  ...
  /**
   * Lookup379: polkadot_runtime_common::auctions::pallet::Call<T>
   **/
  ...
  /**
   * Lookup381: polkadot_runtime_common::crowdloan::pallet::Call<T>
   **/
  ...
  /**
   * Lookup383: sp_runtime::MultiSigner
   **/
  ...
  /**
   * Lookup386: pallet_state_trie_migration::pallet::Call<T>
   **/
  ...
  /**
   * Lookup388: pallet_state_trie_migration::pallet::MigrationLimits
   **/
  ...
  /**
   * Lookup389: pallet_state_trie_migration::pallet::MigrationTask<T>
   **/
  ...
  /**
   * Lookup390: pallet_state_trie_migration::pallet::Progress<MaxKeyLen>
   **/
  ...
  /**
   * Lookup392: pallet_xcm::pallet::Call<T>
   **/
  PalletXcmCall: {
    _enum: {
      send: {
  ...
  /**
   * Lookup393: xcm::VersionedMultiLocation
   **/
  ...
  /**
   * Lookup394: xcm::v2::multilocation::MultiLocation
   **/
  XcmV2MultiLocation: {
    parents: 'u8',
  ...
  /**
   * Lookup395: xcm::v2::multilocation::Junctions
   **/
  ...
  /**
   * Lookup396: xcm::v2::junction::Junction
   **/
  XcmV2Junction: {
    _enum: {
      Parachain: 'Compact<u32>',
  ...
  /**
   * Lookup401: xcm::VersionedXcm<RuntimeCall>
   **/
  XcmVersionedXcm: {
    _enum: {
      __Unused0: 'Null',
  ...
  /**
   * Lookup402: xcm::v2::Xcm<RuntimeCall>
   **/
  XcmV2Xcm: 'Vec<XcmV2Instruction>',
  /**
   * Lookup404: xcm::v2::Instruction<RuntimeCall>
   **/
  XcmV2Instruction: {
    _enum: {
  ...
  /**
   * Lookup405: xcm::v2::multiasset::MultiAssets
   **/
  XcmV2MultiassetMultiAssets: 'Vec<XcmV2MultiAsset>',
  /**
   * Lookup407: xcm::v2::multiasset::MultiAsset
   **/
  XcmV2MultiAsset: {
  ...
  /**
   * Lookup408: xcm::v2::multiasset::AssetId
   **/
  ...
  /**
   * Lookup409: xcm::v2::multiasset::Fungibility
   **/
  ...
  /**
   * Lookup410: xcm::v2::multiasset::AssetInstance
   **/
  ...
  /**
   * Lookup415: xcm::v2::OriginKind
   **/
  XcmV2OriginKind: {
    _enum: ['Native', 'SovereignAccount', 'Superuser', 'Xcm']
  },
  /**
   * Lookup416: xcm::double_encoded::DoubleEncoded<T>
   **/
  XcmDoubleEncoded: {
    encoded: 'Bytes'
  },
  /**
   * Lookup417: xcm::v2::multiasset::MultiAssetFilter
   **/
  ...
  /**
   * Lookup418: xcm::v2::multiasset::WildMultiAsset
   **/
  ...
  /**
   * Lookup419: xcm::v2::multiasset::WildFungibility
   **/
  XcmV2MultiassetWildFungibility: {
    _enum: ['Fungible', 'NonFungible']
  },
  /**
   * Lookup420: xcm::v2::WeightLimit
   **/
  XcmV2WeightLimit: {
    _enum: {
      Unlimited: 'Null',
  ...
  /**
   * Lookup421: xcm::v3::Xcm<Call>
   **/
  XcmV3Xcm: 'Vec<XcmV3Instruction>',
  /**
   * Lookup423: xcm::v3::Instruction<Call>
   **/
  XcmV3Instruction: {
    _enum: {
  ...
  /**
   * Lookup424: xcm::v3::multiasset::MultiAssets
   **/
  XcmV3MultiassetMultiAssets: 'Vec<XcmV3MultiAsset>',
  /**
   * Lookup426: xcm::v3::multiasset::MultiAsset
   **/
  XcmV3MultiAsset: {
  ...
  /**
   * Lookup427: xcm::v3::multiasset::AssetId
   **/
  ...
  /**
   * Lookup428: xcm::v3::multiasset::Fungibility
   **/
  ...
  /**
   * Lookup429: xcm::v3::multiasset::AssetInstance
   **/
  ...
  /**
   * Lookup438: xcm::v3::MaybeErrorCode
   **/
  XcmV3MaybeErrorCode: {
    _enum: {
      Success: 'Null',
  ...
  /**
   * Lookup441: xcm::v3::QueryResponseInfo
   **/
  ...
  /**
   * Lookup442: xcm::v3::multiasset::MultiAssetFilter
   **/
  ...
  /**
   * Lookup443: xcm::v3::multiasset::WildMultiAsset
   **/
  ...
  /**
   * Lookup444: xcm::v3::multiasset::WildFungibility
   **/
  XcmV3MultiassetWildFungibility: {
    _enum: ['Fungible', 'NonFungible']
  },
  /**
   * Lookup445: xcm::v3::WeightLimit
   **/
  XcmV3WeightLimit: {
    _enum: {
      Unlimited: 'Null',
  ...
  /**
   * Lookup446: xcm::VersionedMultiAssets
   **/
  ...
  /**
   * Lookup455: pallet_message_queue::pallet::Call<T>
   **/
  ...
  /**
   * Lookup456: polkadot_runtime_parachains::inclusion::AggregateMessageOrigin
   **/
  ...
  /**
   * Lookup457: polkadot_runtime_parachains::inclusion::UmpQueueId
   **/
  ...
  /**
   * Lookup459: pallet_conviction_voting::types::Tally<Votes, Total>
   **/
  ...
  /**
   * Lookup460: pallet_ranked_collective::pallet::Event<T, I>
   **/
  ...
  /**
   * Lookup461: pallet_ranked_collective::VoteRecord
   **/
  ...
  /**
   * Lookup462: pallet_ranked_collective::Tally<T, I, M>
   **/
  ...
  /**
   * Lookup464: pallet_whitelist::pallet::Event<T>
   **/
  ...
  /**
   * Lookup466: frame_support::dispatch::PostDispatchInfo
   **/
  ...
  /**
   * Lookup468: sp_runtime::DispatchErrorWithPostInfo<frame_support::dispatch::PostDispatchInfo>
   **/
  ...
  /**
   * Lookup469: polkadot_runtime_common::claims::pallet::Event<T>
   **/
  ...
  /**
   * Lookup470: pallet_utility::pallet::Event
   **/
  PalletUtilityEvent: {
    _enum: {
      BatchInterrupted: {
  ...
  /**
   * Lookup472: pallet_identity::pallet::Event<T>
   **/
  PalletIdentityEvent: {
    _enum: {
      IdentitySet: {
  ...
  /**
   * Lookup473: pallet_society::pallet::Event<T, I>
   **/
  PalletSocietyEvent: {
    _enum: {
      Founded: {
  ...
  /**
   * Lookup474: pallet_society::GroupParams<Balance>
   **/
  ...
  /**
   * Lookup475: pallet_recovery::pallet::Event<T>
   **/
  PalletRecoveryEvent: {
    _enum: {
      RecoveryCreated: {
  ...
  /**
   * Lookup476: pallet_vesting::pallet::Event<T>
   **/
  PalletVestingEvent: {
    _enum: {
      VestingUpdated: {
  ...
  /**
   * Lookup477: pallet_scheduler::pallet::Event<T>
   **/
  ...
  /**
   * Lookup479: pallet_proxy::pallet::Event<T>
   **/
  PalletProxyEvent: {
    _enum: {
      ProxyExecuted: {
  ...
  /**
   * Lookup480: pallet_multisig::pallet::Event<T>
   **/
  PalletMultisigEvent: {
    _enum: {
      NewMultisig: {
  ...
  /**
   * Lookup481: pallet_preimage::pallet::Event<T>
   **/
  PalletPreimageEvent: {
    _enum: {
      Noted: {
  ...
  /**
   * Lookup482: pallet_bounties::pallet::Event<T, I>
   **/
  PalletBountiesEvent: {
    _enum: {
      BountyProposed: {
  ...
  /**
   * Lookup483: pallet_child_bounties::pallet::Event<T>
   **/
  ...
  /**
   * Lookup484: pallet_election_provider_multi_phase::pallet::Event<T>
   **/
  ...
  /**
   * Lookup485: pallet_election_provider_multi_phase::ElectionCompute
   **/
  PalletElectionProviderMultiPhaseElectionCompute: {
    _enum: ['OnChain', 'Signed', 'Unsigned', 'Fallback', 'Emergency']
  },
  /**
   * Lookup486: pallet_election_provider_multi_phase::Phase<Bn>
   **/
  ...
  /**
   * Lookup488: pallet_nis::pallet::Event<T>
   **/
  PalletNisEvent: {
    _enum: {
      BidPlaced: {
  ...
  /**
   * Lookup490: pallet_bags_list::pallet::Event<T, I>
   **/
  PalletBagsListEvent: {
    _enum: {
      Rebagged: {
  ...
  /**
   * Lookup491: pallet_nomination_pools::pallet::Event<T>
   **/
  ...
  /**
   * Lookup492: pallet_fast_unstake::pallet::Event<T>
   **/
  ...
  /**
   * Lookup493: polkadot_runtime_parachains::inclusion::pallet::Event<T>
   **/
  ...
  /**
   * Lookup494: polkadot_primitives::v5::CandidateReceipt<primitive_types::H256>
   **/
  ...
  /**
   * Lookup497: polkadot_runtime_parachains::paras::pallet::Event
   **/
  ...
  /**
   * Lookup498: polkadot_runtime_parachains::hrmp::pallet::Event<T>
   **/
  ...
  /**
   * Lookup499: polkadot_runtime_parachains::disputes::pallet::Event<T>
   **/
  ...
  /**
   * Lookup500: polkadot_runtime_parachains::disputes::DisputeLocation
   **/
  PolkadotRuntimeParachainsDisputesDisputeLocation: {
    _enum: ['Local', 'Remote']
  },
  /**
   * Lookup501: polkadot_runtime_parachains::disputes::DisputeResult
   **/
  PolkadotRuntimeParachainsDisputesDisputeResult: {
    _enum: ['Valid', 'Invalid']
  },
  /**
   * Lookup502: polkadot_runtime_common::paras_registrar::pallet::Event<T>
   **/
  ...
  /**
   * Lookup503: polkadot_runtime_common::slots::pallet::Event<T>
   **/
  ...
  /**
   * Lookup504: polkadot_runtime_common::auctions::pallet::Event<T>
   **/
  ...
  /**
   * Lookup505: polkadot_runtime_common::crowdloan::pallet::Event<T>
   **/
  ...
  /**
   * Lookup506: pallet_state_trie_migration::pallet::Event<T>
   **/
  ...
  /**
   * Lookup507: pallet_state_trie_migration::pallet::MigrationCompute
   **/
  PalletStateTrieMigrationMigrationCompute: {
    _enum: ['Signed', 'Auto']
  },
  /**
   * Lookup508: pallet_state_trie_migration::pallet::Error<T>
   **/
  PalletStateTrieMigrationError: {
    _enum: ['MaxSignedLimits', 'KeyTooLong', 'NotEnoughFunds', 'BadWitness', 'SignedMigrationNotAllowed', 'BadChildRoot']
  },
  /**
   * Lookup509: pallet_xcm::pallet::Event<T>
   **/
  PalletXcmEvent: {
    _enum: {
      Attempted: {
  ...
  /**
   * Lookup510: xcm::v3::traits::Outcome
   **/
  XcmV3TraitsOutcome: {
    _enum: {
  ...
  /**
   * Lookup511: pallet_message_queue::pallet::Event<T>
   **/
  ...
  /**
   * Lookup512: frame_support::traits::messages::ProcessMessageError
   **/
  ...
  /**
   * Lookup516: frame_system::LastRuntimeUpgradeInfo
   **/
  ...
  /**
   * Lookup518: frame_system::limits::BlockWeights
   **/
  ...
  /**
   * Lookup519: frame_support::dispatch::PerDispatchClass<frame_system::limits::WeightsPerClass>
   **/
  ...
  /**
   * Lookup520: frame_system::limits::WeightsPerClass
   **/
  ...
  /**
   * Lookup521: frame_system::limits::BlockLength
   **/
  FrameSystemLimitsBlockLength: {
    max: 'FrameSupportDispatchPerDispatchClassU32'
  },
  /**
   * Lookup522: frame_support::dispatch::PerDispatchClass<T>
   **/
  ...
  /**
   * Lookup523: sp_weights::RuntimeDbWeight
   **/
  ...
  /**
   * Lookup524: sp_version::RuntimeVersion
   **/
  ...
  /**
   * Lookup528: frame_system::pallet::Error<T>
   **/
  FrameSystemError: {
    _enum: ['InvalidSpecName', 'SpecVersionNeedsToIncrease', 'FailedToExtractRuntimeVersion', 'NonDefaultComposite', 'NonZeroRefCount', 'CallFiltered']
  },
  /**
   * Lookup535: sp_consensus_babe::digests::PreDigest
   **/
  ...
  /**
   * Lookup536: sp_consensus_babe::digests::PrimaryPreDigest
   **/
  ...
  /**
   * Lookup537: sp_core::sr25519::vrf::VrfSignature
   **/
  ...
  /**
   * Lookup538: sp_consensus_babe::digests::SecondaryPlainPreDigest
   **/
  ...
  /**
   * Lookup539: sp_consensus_babe::digests::SecondaryVRFPreDigest
   **/
  ...
  /**
   * Lookup540: sp_consensus_babe::BabeEpochConfiguration
   **/
  ...
  /**
   * Lookup544: pallet_babe::pallet::Error<T>
   **/
  PalletBabeError: {
    _enum: ['InvalidEquivocationProof', 'InvalidKeyOwnershipProof', 'DuplicateOffenceReport', 'InvalidConfiguration']
  },
  /**
   * Lookup546: pallet_indices::pallet::Error<T>
   **/
  PalletIndicesError: {
  ...
  /**
   * Lookup556: staging_kusama_runtime::RuntimeHoldReason
   **/
  ...
  /**
   * Lookup557: pallet_nis::pallet::HoldReason
   **/
  PalletNisHoldReason: {
    _enum: ['NftReceipt']
  },
  /**
   * Lookup560: pallet_balances::types::IdAmount<Id, Balance>
   **/
  ...
  /**
   * Lookup562: pallet_balances::pallet::Error<T, I>
   **/
  PalletBalancesError: {
  ...
  /**
   * Lookup565: pallet_staking::StakingLedger<T>
   **/
  ...
  /**
   * Lookup567: pallet_staking::UnlockChunk<Balance>
   **/
  ...
  /**
   * Lookup570: pallet_staking::Nominations<T>
   **/
  ...
  /**
   * Lookup572: pallet_staking::ActiveEraInfo
   **/
  ...
  /**
   * Lookup575: pallet_staking::EraRewardPoints<sp_core::crypto::AccountId32>
   **/
  ...
  /**
   * Lookup580: pallet_staking::UnappliedSlash<sp_core::crypto::AccountId32, Balance>
   **/
  ...
  /**
   * Lookup582: pallet_staking::slashing::SlashingSpans
   **/
  ...
  /**
   * Lookup583: pallet_staking::slashing::SpanRecord<Balance>
   **/
  ...
  /**
   * Lookup586: pallet_staking::pallet::pallet::Error<T>
   **/
  ...
  /**
   * Lookup587: sp_staking::offence::OffenceDetails<sp_core::crypto::AccountId32, Offender>
   **/
  ...
  /**
   * Lookup596: sp_core::crypto::KeyTypeId
   **/
  SpCoreCryptoKeyTypeId: '[u8;4]',
  /**
   * Lookup597: pallet_session::pallet::Error<T>
   **/
  PalletSessionError: {
    _enum: ['InvalidProof', 'NoAssociatedValidatorId', 'DuplicatedKey', 'NoKeys', 'NoAccount']
  },
  /**
   * Lookup598: pallet_grandpa::StoredState<N>
   **/
  ...
  /**
   * Lookup599: pallet_grandpa::StoredPendingChange<N, Limit>
   **/
  ...
  /**
   * Lookup601: pallet_grandpa::pallet::Error<T>
   **/
  PalletGrandpaError: {
    _enum: ['PauseFailed', 'ResumeFailed', 'ChangePending', 'TooSoon', 'InvalidKeyOwnershipProof', 'InvalidEquivocationProof', 'DuplicateOffenceReport']
  },
  /**
   * Lookup604: pallet_im_online::pallet::Error<T>
   **/
  PalletImOnlineError: {
    _enum: ['InvalidKey', 'DuplicatedHeartbeat']
  },
  /**
   * Lookup605: pallet_treasury::Proposal<sp_core::crypto::AccountId32, Balance>
   **/
  ...
  /**
   * Lookup609: frame_support::PalletId
   **/
  FrameSupportPalletId: '[u8;8]',
  /**
   * Lookup610: pallet_treasury::pallet::Error<T, I>
   **/
  PalletTreasuryError: {
    _enum: ['InsufficientProposersBalance', 'InvalidIndex', 'TooManyApprovals', 'InsufficientPermission', 'ProposalNotApproved']
  },
  /**
   * Lookup612: pallet_conviction_voting::vote::Voting<Balance, sp_core::crypto::AccountId32, BlockNumber, PollIndex, MaxVotes>
   **/
  ...
  /**
   * Lookup613: pallet_conviction_voting::vote::Casting<Balance, BlockNumber, PollIndex, MaxVotes>
   **/
  ...
  /**
   * Lookup617: pallet_conviction_voting::types::Delegations<Balance>
   **/
  ...
  /**
   * Lookup618: pallet_conviction_voting::vote::PriorLock<BlockNumber, Balance>
   **/
  PalletConvictionVotingVotePriorLock: '(u32,u128)',
  /**
   * Lookup619: pallet_conviction_voting::vote::Delegating<Balance, sp_core::crypto::AccountId32, BlockNumber>
   **/
  ...
  /**
   * Lookup623: pallet_conviction_voting::pallet::Error<T, I>
   **/
  ...
  /**
   * Lookup624: pallet_referenda::types::ReferendumInfo<TrackId, staging_kusama_runtime::OriginCaller, Moment, frame_support::traits::preimages::Bounded<staging_kusama_runtime::RuntimeCall>, Balance, pallet_conviction_voting::types::Tally<Votes, Total>, sp_core::crypto::AccountId32, ScheduleAddress>
   **/
  ...
  /**
   * Lookup625: pallet_referenda::types::ReferendumStatus<TrackId, staging_kusama_runtime::OriginCaller, Moment, frame_support::traits::preimages::Bounded<staging_kusama_runtime::RuntimeCall>, Balance, pallet_conviction_voting::types::Tally<Votes, Total>, sp_core::crypto::AccountId32, ScheduleAddress>
   **/
  ...
  /**
   * Lookup626: pallet_referenda::types::Deposit<sp_core::crypto::AccountId32, Balance>
   **/
  ...
  /**
   * Lookup629: pallet_referenda::types::DecidingStatus<BlockNumber>
   **/
  ...
  /**
   * Lookup637: pallet_referenda::types::TrackInfo<Balance, Moment>
   **/
  ...
  /**
   * Lookup638: pallet_referenda::types::Curve
   **/
  ...
  /**
   * Lookup641: pallet_referenda::pallet::Error<T, I>
   **/
  ...
  /**
   * Lookup642: pallet_ranked_collective::MemberRecord
   **/
  PalletRankedCollectiveMemberRecord: {
    rank: 'u16'
  },
  /**
   * Lookup646: pallet_ranked_collective::pallet::Error<T, I>
   **/
  ...
  /**
   * Lookup647: pallet_referenda::types::ReferendumInfo<TrackId, staging_kusama_runtime::OriginCaller, Moment, frame_support::traits::preimages::Bounded<staging_kusama_runtime::RuntimeCall>, Balance, pallet_ranked_collective::Tally<T, I, M>, sp_core::crypto::AccountId32, ScheduleAddress>
   **/
  ...
  /**
   * Lookup648: pallet_referenda::types::ReferendumStatus<TrackId, staging_kusama_runtime::OriginCaller, Moment, frame_support::traits::preimages::Bounded<staging_kusama_runtime::RuntimeCall>, Balance, pallet_ranked_collective::Tally<T, I, M>, sp_core::crypto::AccountId32, ScheduleAddress>
   **/
  ...
  /**
   * Lookup665: pallet_society::MemberRecord
   **/
  ...
  /**
   * Lookup667: pallet_society::VouchingStatus
   **/
  PalletSocietyVouchingStatus: {
    _enum: ['Vouching', 'Banned']
  },
  /**
   * Lookup668: pallet_society::PayoutRecord<Balance, bounded_collections::bounded_vec::BoundedVec<T, S>>
   **/
  ...
  /**
   * Lookup671: pallet_society::Bid<sp_core::crypto::AccountId32, Balance>
   **/
  PalletSocietyBid: {
    who: 'AccountId32',
  ...
  /**
   * Lookup672: pallet_society::BidKind<sp_core::crypto::AccountId32, Balance>
   **/
  ...
  /**
   * Lookup674: pallet_society::Candidacy<sp_core::crypto::AccountId32, Balance>
   **/
  ...
  /**
   * Lookup675: pallet_society::Tally
   **/
  PalletSocietyTally: {
    approvals: 'u32',
    rejections: 'u32'
  ...
  /**
   * Lookup679: pallet_society::IntakeRecord<sp_core::crypto::AccountId32, Balance>
   **/
  ...
  /**
   * Lookup681: pallet_society::pallet::Error<T, I>
   **/
  PalletSocietyError: {
  ...
  /**
   * Lookup682: pallet_recovery::RecoveryConfig<BlockNumber, Balance, bounded_collections::bounded_vec::BoundedVec<sp_core::crypto::AccountId32, S>>
   **/
  ...
  /**
   * Lookup684: pallet_recovery::ActiveRecovery<BlockNumber, Balance, bounded_collections::bounded_vec::BoundedVec<sp_core::crypto::AccountId32, S>>
   **/
  ...
  /**
   * Lookup685: pallet_recovery::pallet::Error<T>
   **/
  PalletRecoveryError: {
  ...
  /**
   * Lookup688: pallet_vesting::Releases
   **/
  PalletVestingReleases: {
    _enum: ['V0', 'V1']
  },
  /**
   * Lookup689: pallet_vesting::pallet::Error<T>
   **/
  PalletVestingError: {
    _enum: ['NotVesting', 'AtMaxVestingSchedules', 'AmountLow', 'ScheduleIndexOutOfBounds', 'InvalidScheduleParams']
  },
  /**
   * Lookup692: pallet_scheduler::Scheduled<Name, frame_support::traits::preimages::Bounded<staging_kusama_runtime::RuntimeCall>, BlockNumber, staging_kusama_runtime::OriginCaller, sp_core::crypto::AccountId32>
   **/
  ...
  /**
   * Lookup697: pallet_proxy::ProxyDefinition<sp_core::crypto::AccountId32, staging_kusama_runtime::ProxyType, BlockNumber>
   **/
  ...
  /**
   * Lookup701: pallet_proxy::Announcement<sp_core::crypto::AccountId32, primitive_types::H256, BlockNumber>
   **/
  ...
  /**
   * Lookup703: pallet_proxy::pallet::Error<T>
   **/
  PalletProxyError: {
    _enum: ['TooMany', 'NotFound', 'NotProxy', 'Unproxyable', 'Duplicate', 'NoPermission', 'Unannounced', 'NoSelfProxy']
  },
  /**
   * Lookup705: pallet_multisig::Multisig<BlockNumber, Balance, sp_core::crypto::AccountId32, MaxApprovals>
   **/
  ...
  /**
   * Lookup707: pallet_multisig::pallet::Error<T>
   **/
  PalletMultisigError: {
    _enum: ['MinimumThreshold', 'AlreadyApproved', 'NoApprovalsNeeded', 'TooFewSignatories', 'TooManySignatories', 'SignatoriesOutOfOrder', 'SenderInSignatories', 'NotFound', 'NotOwner', 'NoTimepoint', 'WrongTimepoint', 'UnexpectedTimepoint', 'MaxWeightTooLow', 'AlreadyStored']
  },
  /**
   * Lookup708: pallet_preimage::RequestStatus<sp_core::crypto::AccountId32, Balance>
   **/
  ...
  /**
   * Lookup712: pallet_preimage::pallet::Error<T>
   **/
  PalletPreimageError: {
    _enum: ['TooBig', 'AlreadyNoted', 'NotAuthorized', 'NotNoted', 'Requested', 'NotRequested']
  },
  /**
   * Lookup713: pallet_bounties::Bounty<sp_core::crypto::AccountId32, Balance, BlockNumber>
   **/
  ...
  /**
   * Lookup714: pallet_bounties::BountyStatus<sp_core::crypto::AccountId32, BlockNumber>
   **/
  ...
  /**
   * Lookup716: pallet_bounties::pallet::Error<T, I>
   **/
  PalletBountiesError: {
    _enum: ['InsufficientProposersBalance', 'InvalidIndex', 'ReasonTooBig', 'UnexpectedStatus', 'RequireCurator', 'InvalidValue', 'InvalidFee', 'PendingPayout', 'Premature', 'HasActiveChildBounty', 'TooManyQueued']
  },
  /**
   * Lookup717: pallet_child_bounties::ChildBounty<sp_core::crypto::AccountId32, Balance, BlockNumber>
   **/
  ...
  /**
   * Lookup718: pallet_child_bounties::ChildBountyStatus<sp_core::crypto::AccountId32, BlockNumber>
   **/
  ...
  /**
   * Lookup719: pallet_child_bounties::pallet::Error<T>
   **/
  PalletChildBountiesError: {
    _enum: ['ParentBountyNotActive', 'InsufficientBountyBalance', 'TooManyChildBounties']
  },
  /**
   * Lookup720: pallet_election_provider_multi_phase::ReadySolution<AccountId, MaxWinners>
   **/
  ...
  /**
   * Lookup722: pallet_election_provider_multi_phase::RoundSnapshot<sp_core::crypto::AccountId32, DataProvider>
   **/
  ...
  /**
   * Lookup728: pallet_election_provider_multi_phase::signed::SignedSubmission<sp_core::crypto::AccountId32, Balance, staging_kusama_runtime::NposCompactSolution24>
   **/
  ...
  /**
   * Lookup729: pallet_election_provider_multi_phase::pallet::Error<T>
   **/
  ...
  /**
   * Lookup732: pallet_nis::pallet::Bid<Balance, sp_core::crypto::AccountId32>
   **/
  PalletNisBid: {
    amount: 'u128',
    who: 'AccountId32'
  ...
  /**
   * Lookup734: pallet_nis::pallet::SummaryRecord<BlockNumber, Balance>
   **/
  ...
  /**
   * Lookup735: pallet_nis::pallet::ReceiptRecord<sp_core::crypto::AccountId32, BlockNumber, Balance>
   **/
  ...
  /**
   * Lookup737: pallet_nis::pallet::Error<T>
   **/
  PalletNisError: {
  ...
  /**
   * Lookup743: pallet_bags_list::list::Node<T, I>
   **/
  ...
  /**
   * Lookup744: pallet_bags_list::list::Bag<T, I>
   **/
  ...
  /**
   * Lookup746: pallet_bags_list::pallet::Error<T, I>
   **/
  PalletBagsListError: {
    _enum: {
  ...
  /**
   * Lookup747: pallet_bags_list::list::ListError
   **/
  ...
  /**
   * Lookup766: pallet_fast_unstake::types::UnstakeRequest<T>
   **/
  ...
  /**
   * Lookup769: pallet_fast_unstake::pallet::Error<T>
   **/
  PalletFastUnstakeError: {
    _enum: ['NotController', 'AlreadyQueued', 'NotFullyBonded', 'NotQueued', 'AlreadyHead', 'CallNotAllowed']
  },
  /**
   * Lookup770: polkadot_runtime_parachains::configuration::HostConfiguration<BlockNumber>
   **/
  ...
  /**
   * Lookup773: polkadot_runtime_parachains::configuration::pallet::Error<T>
   **/
  PolkadotRuntimeParachainsConfigurationPalletError: {
    _enum: ['InvalidNewValue']
  },
  /**
   * Lookup776: polkadot_runtime_parachains::shared::AllowedRelayParentsTracker<primitive_types::H256, BlockNumber>
   **/
  ...
  /**
   * Lookup779: polkadot_runtime_parachains::inclusion::AvailabilityBitfieldRecord<N>
   **/
  ...
  /**
   * Lookup780: polkadot_runtime_parachains::inclusion::CandidatePendingAvailability<primitive_types::H256, N>
   **/
  ...
  /**
   * Lookup781: polkadot_runtime_parachains::inclusion::pallet::Error<T>
   **/
  ...
  /**
   * Lookup782: polkadot_primitives::v5::ScrapedOnChainVotes<primitive_types::H256>
   **/
  ...
  /**
   * Lookup787: polkadot_runtime_parachains::paras_inherent::pallet::Error<T>
   **/
  ...
  /**
   * Lookup790: polkadot_primitives::v5::CoreOccupied<N>
   **/
  ...
  /**
   * Lookup791: polkadot_primitives::v5::ParasEntry<N>
   **/
  ...
  /**
   * Lookup792: polkadot_primitives::v5::Assignment
   **/
  PolkadotPrimitivesV5Assignment: {
    paraId: 'u32'
  },
  /**
   * Lookup798: polkadot_runtime_parachains::paras::PvfCheckActiveVoteState<BlockNumber>
   **/
  ...
  /**
   * Lookup800: polkadot_runtime_parachains::paras::PvfCheckCause<BlockNumber>
   **/
  ...
  /**
   * Lookup803: polkadot_runtime_parachains::paras::ParaLifecycle
   **/
  ...
  /**
   * Lookup805: polkadot_runtime_parachains::paras::ParaPastCodeMeta<N>
   **/
  ...
  /**
   * Lookup807: polkadot_runtime_parachains::paras::ReplacementTimes<N>
   **/
  ...
  /**
   * Lookup809: polkadot_primitives::v5::UpgradeGoAhead
   **/
  PolkadotPrimitivesV5UpgradeGoAhead: {
    _enum: ['Abort', 'GoAhead']
  },
  /**
   * Lookup810: polkadot_primitives::v5::UpgradeRestriction
   **/
  PolkadotPrimitivesV5UpgradeRestriction: {
    _enum: ['Present']
  },
  /**
   * Lookup811: polkadot_runtime_parachains::paras::ParaGenesisArgs
   **/
  ...
  /**
   * Lookup812: polkadot_runtime_parachains::paras::pallet::Error<T>
   **/
  ...
  /**
   * Lookup814: polkadot_runtime_parachains::initializer::BufferedSessionChange
   **/
  ...
  /**
   * Lookup816: polkadot_core_primitives::InboundDownwardMessage<BlockNumber>
   **/
  ...
  /**
   * Lookup817: polkadot_runtime_parachains::hrmp::HrmpOpenChannelRequest
   **/
  ...
  /**
   * Lookup819: polkadot_runtime_parachains::hrmp::HrmpChannel
   **/
  ...
  /**
   * Lookup821: polkadot_core_primitives::InboundHrmpMessage<BlockNumber>
   **/
  ...
  /**
   * Lookup824: polkadot_runtime_parachains::hrmp::pallet::Error<T>
   **/
  ...
  /**
   * Lookup826: polkadot_primitives::v5::SessionInfo
   **/
  ...
  /**
   * Lookup827: polkadot_primitives::v5::IndexedVec<polkadot_primitives::v5::ValidatorIndex, polkadot_primitives::v5::validator_app::Public>
   **/
  PolkadotPrimitivesV5IndexedVecValidatorIndex: 'Vec<PolkadotPrimitivesV5ValidatorAppPublic>',
  /**
   * Lookup829: polkadot_primitives::v5::IndexedVec<polkadot_primitives::v5::GroupIndex, V>
   **/
  PolkadotPrimitivesV5IndexedVecGroupIndex: 'Vec<Vec<u32>>',
  /**
   * Lookup831: polkadot_primitives::v5::DisputeState<N>
   **/
  ...
  /**
   * Lookup833: polkadot_runtime_parachains::disputes::pallet::Error<T>
   **/
  ...
  /**
   * Lookup834: polkadot_primitives::v5::slashing::PendingSlashes
   **/
  ...
  /**
   * Lookup838: polkadot_runtime_parachains::disputes::slashing::pallet::Error<T>
   **/
  ...
  /**
   * Lookup839: polkadot_runtime_common::paras_registrar::ParaInfo<sp_core::crypto::AccountId32, Balance>
   **/
  ...
  /**
   * Lookup841: polkadot_runtime_common::paras_registrar::pallet::Error<T>
   **/
  ...
  /**
   * Lookup843: polkadot_runtime_common::slots::pallet::Error<T>
   **/
  PolkadotRuntimeCommonSlotsPalletError: {
    _enum: ['ParaNotOnboarding', 'LeaseError']
  },
  /**
   * Lookup848: polkadot_runtime_common::auctions::pallet::Error<T>
   **/
  ...
  /**
   * Lookup849: polkadot_runtime_common::crowdloan::FundInfo<sp_core::crypto::AccountId32, Balance, BlockNumber, LeasePeriod>
   **/
  ...
  /**
   * Lookup850: polkadot_runtime_common::crowdloan::LastContribution<BlockNumber>
   **/
  ...
  /**
   * Lookup851: polkadot_runtime_common::crowdloan::pallet::Error<T>
   **/
  ...
  /**
   * Lookup852: pallet_xcm::pallet::QueryStatus<BlockNumber>
   **/
  ...
  /**
   * Lookup856: xcm::VersionedResponse
   **/
  ...
  /**
   * Lookup862: pallet_xcm::pallet::VersionMigrationStage
   **/
  ...
  /**
   * Lookup865: xcm::VersionedAssetId
   **/
  XcmVersionedAssetId: {
    _enum: {
      __Unused0: 'Null',
  ...
  /**
   * Lookup866: pallet_xcm::pallet::RemoteLockedFungibleRecord<ConsumerIdentifier, MaxConsumers>
   **/
  ...
  /**
   * Lookup873: pallet_xcm::pallet::Error<T>
   **/
  PalletXcmError: {
  ...
  /**
   * Lookup874: pallet_message_queue::BookState<polkadot_runtime_parachains::inclusion::AggregateMessageOrigin>
   **/
  ...
  /**
   * Lookup876: pallet_message_queue::Neighbours<polkadot_runtime_parachains::inclusion::AggregateMessageOrigin>
   **/
  ...
  /**
   * Lookup878: pallet_message_queue::Page<Size, HeapSize>
   **/
  ...
  /**
   * Lookup880: pallet_message_queue::pallet::Error<T>
   **/
  PalletMessageQueueError: {
    _enum: ['NotReapable', 'NoPage', 'NoMessage', 'AlreadyProcessed', 'Queued', 'InsufficientWeight', 'TemporarilyUnprocessable', 'QueuePaused']
  },
  /**
   * Lookup883: frame_system::extensions::check_non_zero_sender::CheckNonZeroSender<T>
   **/
  FrameSystemExtensionsCheckNonZeroSender: 'Null',
  /**
   * Lookup884: frame_system::extensions::check_spec_version::CheckSpecVersion<T>
   **/
  FrameSystemExtensionsCheckSpecVersion: 'Null',
  /**
   * Lookup885: frame_system::extensions::check_tx_version::CheckTxVersion<T>
   **/
  FrameSystemExtensionsCheckTxVersion: 'Null',
  /**
   * Lookup886: frame_system::extensions::check_genesis::CheckGenesis<T>
   **/
  FrameSystemExtensionsCheckGenesis: 'Null',
  /**
   * Lookup889: frame_system::extensions::check_nonce::CheckNonce<T>
   **/
  FrameSystemExtensionsCheckNonce: 'Compact<u32>',
  /**
   * Lookup890: frame_system::extensions::check_weight::CheckWeight<T>
   **/
  FrameSystemExtensionsCheckWeight: 'Null',
  /**
   * Lookup891: pallet_transaction_payment::ChargeTransactionPayment<T>
   **/
  PalletTransactionPaymentChargeTransactionPayment: 'Compact<u128>',
  /**
   * Lookup892: staging_kusama_runtime::Runtime
   **/
