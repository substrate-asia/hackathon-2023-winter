...
import { FrameSupportTokensMiscBalanceStatus, SpRuntimeDispatchError, PalletElectionProviderMultiPhaseElectionCompute, SpNposElectionsElectionScore, PalletElectionProviderMultiPhasePhase, PalletRankedCollectiveVoteRecord, PalletRankedCollectiveTally, FrameSupportPreimagesBounded, SpConsensusGrandpaAppPublic, PolkadotParachainPrimitivesPrimitivesHrmpChannelId, PalletImOnlineSr25519AppSr25519Public, PalletStakingExposure, PolkadotRuntimeParachainsInclusionAggregateMessageOrigin, SpWeightsWeightV2Weight, FrameSupportMessagesProcessMessageError, PalletMultisigTimepoint, PalletNominationPoolsCommissionChangeRate, PalletNominationPoolsPoolState, PolkadotPrimitivesV5CandidateReceipt, PolkadotRuntimeParachainsDisputesDisputeResult, PolkadotRuntimeParachainsDisputesDisputeLocation, StagingKusamaRuntimeProxyType, PalletConvictionVotingTally, PalletSocietyGroupParams, PalletStakingForcing, PalletStakingValidatorPrefs, PalletStateTrieMigrationError, PalletStateTrieMigrationMigrationCompute, FrameSupportDispatchDispatchInfo, FrameSupportDispatchPostDispatchInfo, SpRuntimeDispatchErrorWithPostInfo, StagingXcmV3MultiLocation, XcmVersionedMultiAssets, XcmV3TraitsOutcome, XcmV3MultiassetMultiAssets, XcmVersionedMultiLocation, XcmV3TraitsError, XcmV3Response, XcmV3Xcm } from '@polkadot/types/lookup';

export type __AugmentedEvent<ApiType extends ApiTypes> = AugmentedEvent<ApiType>;

declare module '@polkadot/api-base/types/events' {
  interface KusamaAugmentedEvents<ApiType extends ApiTypes> {
    auctions: {
      /**
    ...
    hrmp: {
       ...
       **/
      ChannelClosed: AugmentedEvent<ApiType, [u32, PolkadotParachainPrimitivesPrimitivesHrmpChannelId]>;
      /**
       ...
       **/
      OpenChannelCanceled: AugmentedEvent<ApiType, [u32, PolkadotParachainPrimitivesPrimitivesHrmpChannelId]>;
      /**
