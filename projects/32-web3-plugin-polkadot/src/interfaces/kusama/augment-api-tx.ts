...
import { SpConsensusBabeDigestsNextConfigDescriptor, SpConsensusSlotsEquivocationProof, SpSessionMembershipProof, SpConsensusBeefyEquivocationProof, PolkadotRuntimeCommonClaimsEcdsaSignature, PolkadotRuntimeCommonClaimsStatementKind, PolkadotPrimitivesVstagingAsyncBackingParams, PolkadotPrimitivesV5ExecutorParams, PalletConvictionVotingConviction, PalletConvictionVotingVoteAccountVote, SpRuntimeMultiSignature, SpRuntimeMultiSigner, SpNposElectionsSupport, SpNposElectionsElectionScore, KusamaPalletElectionProviderMultiPhaseRawSolution, PalletElectionProviderMultiPhaseSolutionOrSnapshotSize, StagingKusamaRuntimeOriginCaller, FrameSupportPreimagesBounded, FrameSupportScheduleDispatchTime, SpConsensusGrandpaEquivocationProof, PolkadotParachainPrimitivesPrimitivesHrmpChannelId, PalletIdentityJudgement, PalletIdentityBitFlags, PalletIdentityIdentityInfo, PalletImOnlineHeartbeat, PalletImOnlineSr25519AppSr25519Signature, PolkadotRuntimeParachainsInclusionAggregateMessageOrigin, SpWeightsWeightV2Weight, PalletMultisigTimepoint, PalletNominationPoolsBondExtra, PalletNominationPoolsClaimPermission, PalletNominationPoolsCommissionChangeRate, PalletNominationPoolsConfigOpU128, PalletNominationPoolsConfigOpU32, PalletNominationPoolsConfigOpPerbill, PalletNominationPoolsPoolState, PalletNominationPoolsConfigOpAccountId32, PolkadotPrimitivesV5InherentData, PolkadotPrimitivesV5PvfCheckStatement, PolkadotPrimitivesV5ValidatorAppSignature, PolkadotPrimitivesV5SlashingDisputeProof, StagingKusamaRuntimeProxyType, StagingKusamaRuntimeSessionKeys, PalletStakingRewardDestination, PalletStakingPalletConfigOpU128, PalletStakingPalletConfigOpU32, PalletStakingPalletConfigOpPercent, PalletStakingPalletConfigOpPerbill, PalletStakingValidatorPrefs, PalletStateTrieMigrationMigrationLimits, PalletStateTrieMigrationMigrationTask, PalletStateTrieMigrationProgress, PalletVestingVestingInfo, XcmVersionedXcm, XcmVersionedMultiLocation, StagingXcmV3MultiLocation, XcmVersionedMultiAssets, XcmV3WeightLimit } from '@polkadot/types/lookup';
...
declare module '@polkadot/api-base/types/submittable' {
  interface KusamaAugmentedSubmittables<ApiType extends ApiTypes> {
    auctions: {
      /**
       * See [`Pallet::bid`].
       **/
    ...
    electionProviderMultiPhase: {
       ...
       * See [`Pallet::submit`].
       **/
      submit: AugmentedSubmittable<(rawSolution: KusamaPalletElectionProviderMultiPhaseRawSolution | { solution?: any; score?: any; round?: any } | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [KusamaPalletElectionProviderMultiPhaseRawSolution]>;
      /**
       * See [`Pallet::submit_unsigned`].
       **/
      submitUnsigned: AugmentedSubmittable<(rawSolution: KusamaPalletElectionProviderMultiPhaseRawSolution | { solution?: any; score?: any; round?: any } | string | Uint8Array, witness: PalletElectionProviderMultiPhaseSolutionOrSnapshotSize | { voters?: any; targets?: any } | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [KusamaPalletElectionProviderMultiPhaseRawSolution, PalletElectionProviderMultiPhaseSolutionOrSnapshotSize]>;
      /**
       * Generic tx
       **/
      [key: string]: SubmittableExtrinsicFunction<ApiType>;
    ...
    session: {
       ...
       * See [`Pallet::set_keys`].
       **/
      setKeys: AugmentedSubmittable<(keys: StagingKusamaRuntimeSessionKeys | { grandpa?: any; babe?: any; imOnline?: any; paraValidator?: any; paraAssignment?: any; authorityDiscovery?: any; beefy?: any } | string | Uint8Array, proof: Bytes | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [StagingKusamaRuntimeSessionKeys, Bytes]>;
      /**
       * Generic tx
       **/
      [key: string]: SubmittableExtrinsicFunction<ApiType>;
