 ...
 */
export interface KusamaSimpleRpcInterface {
  author: {
    /**
     * Returns true if the keystore has private keys for the given public key and key type.
     **/
...
export class KusamaRpcBaseClass implements SimpleRpcInterface {
  public get author() {
    return {
