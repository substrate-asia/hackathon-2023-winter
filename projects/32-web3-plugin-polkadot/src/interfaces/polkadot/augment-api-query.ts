...
import { SpConsensusBabeAppPublic, SpConsensusBabeBabeEpochConfiguration, SpConsensusBabeDigestsPreDigest, SpConsensusBabeDigestsNextConfigDescriptor, PalletBalancesAccountData, PalletBalancesIdAmount, PolkadotRuntimeRuntimeHoldReason, PalletBalancesBalanceLock, PalletBalancesReserveData, PalletBountiesBounty, PalletChildBountiesChildBounty, PolkadotRuntimeCommonClaimsStatementKind, PolkadotRuntimeParachainsConfigurationHostConfiguration, PalletConvictionVotingVoteVoting, PolkadotRuntimeCommonCrowdloanFundInfo, PolkadotCorePrimitivesInboundDownwardMessage, PalletElectionProviderMultiPhasePhase, SpNposElectionsElectionScore, PalletElectionProviderMultiPhaseReadySolution, PolkadotPalletElectionProviderMultiPhaseSignedSignedSubmission, PalletElectionProviderMultiPhaseRoundSnapshot, PalletElectionProviderMultiPhaseSolutionOrSnapshotSize, PalletFastUnstakeUnstakeRequest, PalletGrandpaStoredPendingChange, PalletGrandpaStoredState, PolkadotParachainPrimitivesPrimitivesHrmpChannelId, PolkadotCorePrimitivesInboundHrmpMessage, PolkadotRuntimeParachainsHrmpHrmpChannel, PolkadotRuntimeParachainsHrmpHrmpOpenChannelRequest, PalletIdentityRegistration, PalletIdentityRegistrarInfo, PalletImOnlineSr25519AppSr25519Public, PolkadotRuntimeParachainsInitializerBufferedSessionChange, PolkadotRuntimeParachainsInclusionAggregateMessageOrigin, PalletMessageQueueBookState, PalletMessageQueuePage, PalletMultisigMultisig, PalletNominationPoolsBondedPoolInner, PalletNominationPoolsClaimPermission, PalletNominationPoolsPoolMember, PalletNominationPoolsRewardPool, PalletNominationPoolsSubPools, SpStakingOffenceOffenceDetails, PolkadotRuntimeParachainsInclusionAvailabilityBitfieldRecord, PolkadotRuntimeParachainsInclusionCandidatePendingAvailability, PolkadotPrimitivesV5CandidateCommitments, PolkadotPrimitivesV5ScrapedOnChainVotes, PolkadotRuntimeParachainsParasParaLifecycle, PolkadotRuntimeParachainsParasParaPastCodeMeta, PolkadotRuntimeParachainsParasPvfCheckActiveVoteState, PolkadotRuntimeParachainsParasParaGenesisArgs, PolkadotPrimitivesV5UpgradeGoAhead, PolkadotPrimitivesV5UpgradeRestriction, PolkadotPrimitivesV5CoreOccupied, PolkadotPrimitivesV5ParasEntry, PolkadotPrimitivesV5DisputeState, PolkadotPrimitivesV5AssignmentAppPublic, PolkadotPrimitivesV5ExecutorParams, PolkadotPrimitivesV5SessionInfo, PolkadotPrimitivesV5ValidatorAppPublic, PolkadotRuntimeParachainsSharedAllowedRelayParentsTracker, PolkadotPrimitivesV5SlashingPendingSlashes, PalletPreimageRequestStatus, PalletProxyAnnouncement, PalletProxyProxyDefinition, PalletReferendaReferendumInfo, PolkadotRuntimeCommonParasRegistrarParaInfo, PolkadotPalletSchedulerScheduled, SpCoreCryptoKeyTypeId, PolkadotRuntimeSessionKeys, PalletStakingActiveEraInfo, PalletStakingEraRewardPoints, PalletStakingExposure, PalletStakingValidatorPrefs, PalletStakingForcing, PalletStakingStakingLedger, PalletStakingNominations, PalletStakingRewardDestination, PalletStakingSlashingSlashingSpans, PalletStakingSlashingSpanRecord, PalletStakingUnappliedSlash, FrameSystemAccountInfo, FrameSupportDispatchPerDispatchClassWeight, SpRuntimeDigest, FrameSystemEventRecord, FrameSystemPhase, FrameSystemLastRuntimeUpgradeInfo, PalletTransactionPaymentReleases, PalletTreasuryProposal, PalletVestingReleases, PalletVestingVestingInfo, PalletBagsListListBag, PalletBagsListListNode, PalletXcmVersionMigrationStage, XcmVersionedMultiLocation, PalletXcmQueryStatus, XcmVersionedAssetId, PalletXcmRemoteLockedFungibleRecord, SpWeightsWeightV2Weight } from '@polkadot/types/lookup';

export type __AugmentedQuery<ApiType extends ApiTypes> = AugmentedQuery<ApiType, () => unknown>;
export type __QueryableStorageEntry<ApiType extends ApiTypes> = QueryableStorageEntry<ApiType>;

declare module '@polkadot/api-base/types/storage' {
  interface PolkadotAugmentedQueries<ApiType extends ApiTypes> {
    auctions: {
      /**
    ...
    electionProviderMultiPhase: {
       ...
       **/
      signedSubmissionsMap: AugmentedQuery<ApiType, (arg: u32 | AnyNumber | Uint8Array) => Observable<Option<PolkadotPalletElectionProviderMultiPhaseSignedSignedSubmission>>, [u32]> & QueryableStorageEntry<ApiType, [u32]>;
      /**
    ...
    scheduler: {
       ...
       **/
      agenda: AugmentedQuery<ApiType, (arg: u32 | AnyNumber | Uint8Array) => Observable<Vec<Option<PolkadotPalletSchedulerScheduled>>>, [u32]> & QueryableStorageEntry<ApiType, [u32]>;
