...
import { FrameSupportPalletId, SpWeightsWeightV2Weight, PalletReferendaTrackInfo, FrameSystemLimitsBlockLength, FrameSystemLimitsBlockWeights, SpWeightsRuntimeDbWeight, SpVersionRuntimeVersion } from '@polkadot/types/lookup';

export type __AugmentedConst<ApiType extends ApiTypes> = AugmentedConst<ApiType>;

declare module '@polkadot/api-base/types/consts' {
  interface PolkadotAugmentedConsts<ApiType extends ApiTypes> {
    auctions: {
      /**
