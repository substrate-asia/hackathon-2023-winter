...
import { SpConsensusBabeDigestsNextConfigDescriptor, SpConsensusSlotsEquivocationProof, SpSessionMembershipProof, PolkadotRuntimeCommonClaimsEcdsaSignature, PolkadotRuntimeCommonClaimsStatementKind, PolkadotPrimitivesVstagingAsyncBackingParams, PolkadotPrimitivesV5ExecutorParams, PalletConvictionVotingConviction, PalletConvictionVotingVoteAccountVote, SpRuntimeMultiSignature, SpRuntimeMultiSigner, SpNposElectionsSupport, SpNposElectionsElectionScore, PalletElectionProviderMultiPhaseRawSolution, PalletElectionProviderMultiPhaseSolutionOrSnapshotSize, SpConsensusGrandpaEquivocationProof, PolkadotParachainPrimitivesPrimitivesHrmpChannelId, PalletIdentityJudgement, PalletIdentityBitFlags, PalletIdentityIdentityInfo, PalletImOnlineHeartbeat, PalletImOnlineSr25519AppSr25519Signature, PolkadotRuntimeParachainsInclusionAggregateMessageOrigin, SpWeightsWeightV2Weight, PalletMultisigTimepoint, PalletNominationPoolsBondExtra, PalletNominationPoolsClaimPermission, PalletNominationPoolsCommissionChangeRate, PalletNominationPoolsConfigOpU128, PalletNominationPoolsConfigOpU32, PalletNominationPoolsConfigOpPerbill, PalletNominationPoolsPoolState, PalletNominationPoolsConfigOpAccountId32, PolkadotPrimitivesV5InherentData, PolkadotPrimitivesV5PvfCheckStatement, PolkadotPrimitivesV5ValidatorAppSignature, PolkadotPrimitivesV5SlashingDisputeProof, PolkadotRuntimeProxyType, PolkadotRuntimeOriginCaller, FrameSupportPreimagesBounded, FrameSupportScheduleDispatchTime, PolkadotRuntimeSessionKeys, PalletStakingRewardDestination, PalletStakingPalletConfigOpU128, PalletStakingPalletConfigOpU32, PalletStakingPalletConfigOpPercent, PalletStakingPalletConfigOpPerbill, PalletStakingValidatorPrefs, PalletVestingVestingInfo, XcmVersionedXcm, XcmVersionedMultiLocation, StagingXcmV3MultiLocation, XcmVersionedMultiAssets, XcmV3WeightLimit } from '@polkadot/types/lookup';
...
declare module '@polkadot/api-base/types/submittable' {
  interface PolkadotAugmentedSubmittables<ApiType extends ApiTypes> {
    auctions: {
      /**
       * See [`Pallet::bid`].
       **/
