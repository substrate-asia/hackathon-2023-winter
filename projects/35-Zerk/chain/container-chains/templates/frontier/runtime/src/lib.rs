...
construct_runtime!(
    pub enum Runtime
    {
		...
		TemplateModule: pallet_template = 101,

        Council: pallet_collective::<Instance1> = 102,
		TechnicalCommittee: pallet_collective::<Instance2> = 103,
        AllianceMotion: pallet_collective::<Instance3> = 104,
        Treasury: pallet_treasury = 105,
