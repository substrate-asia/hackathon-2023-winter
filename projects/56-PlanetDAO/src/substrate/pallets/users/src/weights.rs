...
//! Autogenerated weights for users
//!
...
/// Weight functions needed for users.
pub trait WeightInfo {
	fn login_user() -> Weight;
	fn register_user() -> Weight;
}

/// Weights for users using the Substrate node and recommended hardware.
