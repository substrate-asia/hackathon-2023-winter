...
const DAOCard = ({ item, onJoinCommunity, hasJoined, className }: { item: Dao; onJoinCommunity?: MouseEventHandler<HTMLButtonElement>; hasJoined: boolean; className?: string }) => {
  ...
  return (
    <Card className={`${className} max-w-[720px]`}>
