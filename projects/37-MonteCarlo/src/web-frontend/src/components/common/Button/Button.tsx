import { Animated, type AnimatedProp, cx, FrameSVGOctagon, Illuminator, useBleeps } from '@arwes/react'
  ...
  return (
    <Animated<HTMLButtonElement, HTMLProps<HTMLButtonElement>>
      ...
      className={cx(
        ...
        className,
        '[&>div:nth-child(2)]:disabled:text-#b5c2c2/60 [&>div:nth-child(2)]:disabled:text-shadow'
      )}
      animated={animated}
      tabIndex={tabIndex}
      title={title}
    ...
    >
      ...
      {frame === 'hexagon' && (
        <div className={cx(classes.frameElement, classes.frameHexagonClip)}>
          <Illuminator className={classes.frameHexagonIlluminator} color="hsl(60 50% 90% / 8%)" size={200} />
