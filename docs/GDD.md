...
- **Mana**:
  A pivotal resource, primarily generated by humans, and crucial for game progression.
- **Humans**:
  Humans are the most important resource, as they generate mana and they are harvesting resources, like wood and stones.
- **Water**:
  Key resources to maintain humans and let them flourish and grow. Can be obtained through water and mountain tiles.
- **Food**:
   Key resources to maintain humans and let them flourish and grow. Can be obtained through many tiles.
- **Wood**:
  This resource is mostly used to build buildings, and upgrade them, the most common tile to harvest wood is the forest tile.
- **Stone**:
  This resource is mostly used to build buildings, but can also be used as a primitive weapon, however, tiles like cave and mountain are harvested for stones.
- **Gold**:
  The gold resources are very valuable, it's currently unknown, which tile provides it, but rumors say, that caves, mountains, and deserts, can be lucky ones.
